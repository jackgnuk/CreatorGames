...
public class CommandAddTeammate implements CommandExecutor {
    private final CreatorGames instance;

    public CommandAddTeammate(CreatorGames instance) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length != 2) {
            sender.sendMessage("You have provided too many arguments. /addteammate <teamID> <player>");
        } else {
            ...
            try {
                ...
                sender.sendMessage("Player is not online! Player must be online to be added to a team");
                return true;
            }
